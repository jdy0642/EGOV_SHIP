...
>>>>>>> yyh
	...
	private String makeUname() {
		List<String> fName = Arrays.asList("김", "이", "박", "최", "정", "강", "조", "윤", "장", "임", "한", "오", "서", "신", "권",
				...
				"용");
		List<String> lName = Arrays.asList("가", "강", "건", "경", "고", "관", "광", "구", "규", "근", "기", "길", "나", "남", "노",
...
=======
	...
	public User makeUser() {
		return new User(makeUid(), "1", makeUname(), makeAge(), makeGender(), makeLoc(), makeTel(), makeEmail(),
				makeUpoint(), makeScore(), makeWin(), makeHitmap(), makeKm(), makeHeart(), makeAuthor(), makeLolName());
	}
